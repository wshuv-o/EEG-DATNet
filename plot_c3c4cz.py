...
#------------------------------
# datasetA1 = MotorImageryDataset('dataset/A08T.npz')
# trials, classes = datasetA1.get_trials_from_channels(range(22))
# print(classes)
# classes=classes[1]
# print(f"trials shape {np.array(trials).shape}")
# print(f"classes shape {np.array(classes).shape}")
...
# # Map the class labels to their corresponding integer values
# mapped_classes = np.array([class_mapping[label] for label in classes])
# temp=np.array(trials)
# reshaped_trials= temp.transpose(1,0,2)
